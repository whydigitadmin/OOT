...
@Component({
  selector: 'app-sea-export-details',
  templateUrl: './sea-export-details.component.html',
  styleUrls: ['./sea-export-details.component.scss']
})
export class SeaExportDetailsComponent implements OnInit {
