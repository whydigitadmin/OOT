...
// import { OperationDashboard1Component } from '../operation-dashboard1/operation-dashboard1component';

@NgModule({
  declarations: [SeaDashboardComponent,
  ...
  imports: [
    ...
    RouterModule.forChild([
      ...
      //   component: OperationDashboard1Component
      // },
    ]),
  ]
})
